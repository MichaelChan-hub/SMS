...
namespace SMS.BLL
{
    public class StoreRegionBLL
    {
        ...
        /// <returns></returns>
        public List<ViewStoreRegionInfo> FindStoreRegionList(int storeId, int stateId, string keywords)
        {
            return vsrDAL.FindStoreRegionList(storeId, stateId, keywords, 0);
        }
